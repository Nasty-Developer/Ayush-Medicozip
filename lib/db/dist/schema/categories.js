...
export const categoriesTable = pgTable("categories", {
    ...
    /**
     * Which product collection this category belongs to.
     * "medicine"   → pharmacy medicines (default, backward compatible)
     * "veterinary" → veterinary medicines
     * "general"    → general healthcare / daily products
     */
    collectionType: text("collection_type", {
        enum: ["medicine", "veterinary", "general"],
    }).default("medicine").notNull(),
