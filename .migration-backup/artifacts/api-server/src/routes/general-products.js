...
import { generalProductsTable, categoriesTable, } from "@workspace/db";
...
router.get("/categories", async (_req, res) => {
    try {
        const rows = await db
            ...
            .leftJoin(generalProductsTable, and(eq(generalProductsTable.categoryId, categoriesTable.id), eq(generalProductsTable.status, "active")))
            .where(and(eq(categoriesTable.enabled, true), eq(categoriesTable.collectionType, "general")))
