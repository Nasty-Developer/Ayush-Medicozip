...
import {
  ...
  RefreshCw, Scale, PawPrint, ShoppingBag,
} from "lucide-react";
...
import VetMedicinesPage from "./VetMedicinesPage";
import GeneralProductsPage from "./GeneralProductsPage";
...
function buildNavItems(newInquiries: number, pendingRequests: number): NavItemDef[] {
  return [
    ...
    { icon: PawPrint,   label: "Vet Medicines",      href: "/admin/vet-medicines" },
    { icon: ShoppingBag,label: "General Products",   href: "/admin/general-products" },
      ...
      <div className="lg:ml-64">
        ...
        <main className="p-4 sm:p-6 lg:p-8">
          <Switch>
            ...
            <Route path="/admin/vet-medicines" component={VetMedicinesPage} />
            <Route path="/admin/general-products" component={GeneralProductsPage} />
