...
export type OrderStatus =
  ...
  | "payment-verification-pending" // Customer says payment was completed; admin review required
  | "payment-verified"    // Payment confirmed
  | "confirmed"           // Order confirmed after payment/prescription review
...
export function canCustomerCancel(status: OrderStatus): boolean {
  return ["pending", "payment-pending", "payment-verification-pending"].includes(status);
}
