...
export type PaymentStatus = "pending" | "verification-pending" | "paid" | "verified" | "failed" | "refunded" | "completed";
...
export async function reviewOrderPrescription(
  ...
  await authFetchJson(`/api/orders/${docId}/prescription/review`, {
    method: "POST",
